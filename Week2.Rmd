---
title: "Week 2: Distributions and proportions"
...
`read_csv()` loads the data into our environment and `attach` basically activates it so that when we refer to one of the variable in that dataframe, it knows which dataframe to look for it in.
