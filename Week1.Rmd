...
Before you start, you'll need to make sure the following packages are installed:
...
You can save any of the datasets you just created for future use by writing them to a csv file. For example, you might decide to save the person-level data.
